...
DROP TABLE IF EXISTS Lista_camere CASCADE;
DROP TABLE IF EXISTS Lista_operazioni CASCADE;
DROP TABLE IF EXISTS capi_reparto CASCADE;
...
CREATE TABLE IF NOT EXISTS Capi_reparto(
    badge INT,
...
CREATE TABLE IF NOT EXISTS Lista_camere(
