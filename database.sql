...
(101, 'Luca', 'Bianchi', 'chirurgo', '1910-09-12', 'Milano', 32000, TRUE, 'Chirurgia'),
(102, 'Giulia', 'Sartori', 'medico', '1988-03-22', 'Napoli', 29000, FALSE, 'Neurologia'),
(103, 'Francesca', 'Russo', 'chirurgo', '1962-08-19', 'Torino', 34000, FALSE, 'Ortopedia'),
(104, 'Alessandro', 'Ferrari', 'medico', '1990-12-11', 'Palermo', 27000, TRUE, 'Pediatria'),
(105, 'Chiara', 'Esposito', 'chirurgo', '1978-06-07', 'Firenze', 33000, FALSE, 'Chirurgia'),
(106, 'Marco', 'Bruno', 'medico', '1985-01-24', 'Bologna', 26000, FALSE, 'Oncologia'),
(107, 'Elena', 'Marini', 'chirurgo', '1965-04-16', 'Genova', 34500, TRUE, 'Cardiologia'),
(108, 'Andrea', 'Galli', 'medico', '1992-11-09', 'Venezia', 23000, FALSE, 'Ostetricia'),
(109, 'Valentina', 'Conti', 'chirurgo', '1958-02-03', 'Verona', 31000, FALSE, 'Gastroenterologia'),
(110, 'Paolo', 'Barbieri', 'medico', '1960-09-14', 'Trieste', 28000, FALSE, 'Dermatologia'),
(111, 'Sara', 'Rinaldi', 'chirurgo', '1977-12-30', 'Cagliari', 32000, FALSE, 'Oncologia'),
(112, 'Giorgio', 'Grassi', 'medico', '1983-07-21', 'Perugia', 25000, TRUE, 'Urologia'),
(113, 'Marta', 'Colombo', 'chirurgo', '1989-04-08', 'Ancona', 30000, FALSE, 'Ortopedia'),
(114, 'Giovanni', 'Fabbri', 'medico', '1970-05-19', 'Trento', 27000, TRUE, 'Neurologia'),
(115, 'Anna', 'Romano', 'chirurgo', '1959-06-15', 'Udine', 34000, FALSE, 'Chirurgia'),
(116, 'Roberto', 'Ricci', 'medico', '1986-11-28', 'Rimini', 26000, FALSE, 'Cardiologia'),
(117, 'Elisa', 'Orlandi', 'chirurgo', '1963-01-17', 'Pisa', 34500, FALSE, 'Ostetricia'),
(118, 'Stefano', 'Cattaneo', 'medico', '1991-03-24', 'Lecce', 23000, FALSE, 'Pediatria'),
(119, 'Monica', 'Pagani', 'chirurgo', '1964-08-11', 'Messina', 31000, TRUE, 'Oncologia'),
(120, 'Luigi', 'Pellegrini', 'medico', '1957-02-20', 'Bolzano', 28000, TRUE, 'Gastroenterologia'),
(121, 'Claudia', 'Rizzi', 'chirurgo', '1967-07-30', 'Aosta', 33000, FALSE, 'Neurologia'),
(122, 'Fabio', 'Marchetti', 'medico', '1987-10-05', 'Reggio Calabria', 25000, FALSE, 'Cardiologia'),
(123, 'Silvia', 'Donati', 'chirurgo', '1980-12-12', 'Savona', 32000, FALSE, 'Chirurgia'),
(124, 'Matteo', 'Ferraro', 'medico', '1973-09-25', 'Forlì', 27000, TRUE, 'Ostetricia'),
(125, 'Federica', 'Piazza', 'chirurgo', '1966-04-18', 'Treviso', 34000, TRUE, 'Ortopedia'),
(126, 'Antonio', 'Villa', 'medico', '1990-08-07', 'Siena', 26000, FALSE, 'Urologia'),
(127, 'Ilaria', 'Caruso', 'chirurgo', '1981-06-23', 'Bari', 34500, FALSE, 'Gastroenterologia'),
(128, 'Riccardo', 'Mancini', 'medico', '1961-03-31', 'Vicenza', 23000, TRUE, 'Dermatologia'),
